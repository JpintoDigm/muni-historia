...
import EventMap from "../components/arcgis/basemap/EventMap";
import AerometroMap from "../components/arcgis/basemap/AerometroMap";
      ...
      <section className="w-full p-6 lg:px-4 lg:py-8  ">
        <div className="w-full container mx-auto flex flex-col gap-4">
          ...
          <div className="w-full sm:w-2/3">
            <p
              className={` ${muni.className} text-muni-azul text-justify text-base sm:text-xl lg:text-xl my-10`}
            >
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col items-end w-100 sm:w-225">
              <p className={`${muni.className} text-center text-muni-azul text-base sm:text-xl lg:text-xl px-10 md:px-0`}>
